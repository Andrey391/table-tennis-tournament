...
-- 20. In-app notifications (see Notification in schema.prisma). Deleting a user
-- takes their inbox with them; tournamentId is deliberately not a foreign key.
...
CREATE INDEX IF NOT EXISTS "Notification_tournamentId_idx" ON "Notification"("tournamentId");
DO $$ BEGIN
