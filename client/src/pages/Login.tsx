    ...
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[#666680] text-sm mt-3">Sign in to your account</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4 bg-[#12121a] p-6 rounded-lg border border-[#1e1e2e]">
          ...
          <div>
            ...
            <input type="email" placeholder="you@example.com" value={email} onChange={e => setEmail(e.target.value)}
              className="w-full px-3 py-2.5 bg-[#0a0a0f] rounded border border-[#1e1e2e] text-sm focus:border-[#ccff00] focus:outline-none transition-colors" required />
          </div>
          <div>
