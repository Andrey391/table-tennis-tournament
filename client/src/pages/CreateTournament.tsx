      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-[#12121a] p-4 rounded-lg border border-[#1e1e2e]">
        ...
        <div>
          ...
          <input type="text" placeholder="e.g. Friday Night Club" value={form.name} onChange={e => set("name", e.target.value)}
            className="w-full px-3 py-3 bg-[#0a0a0f] rounded border border-[#1e1e2e] focus:border-[#ccff00] focus:outline-none" required />
        </div>
        <div>
          ...
          <input type="number" min={1} value={form.tablesCount} onChange={e => set("tablesCount", +e.target.value)}
            className="w-full px-3 py-3 bg-[#0a0a0f] rounded border border-[#1e1e2e] focus:border-[#ccff00] focus:outline-none" />
        </div>
        ...
        <div className="flex gap-3 pt-1">
          ...
          <button type="submit" disabled={loading} className="flex-1 bg-[#ccff00] text-[#0a0a0f] py-3 rounded-lg text-sm font-bold disabled:opacity-50">
